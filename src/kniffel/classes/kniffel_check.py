...
class KniffelCheck:
    ...
    def check_full_house(self, ds: DiceSet):
        ...
        has_three_same = True if self.occures_n_times(ds, 3) else False
        has_two_same = (
            True if self.occures_n_times(ds, 2, blacklist=[three_times]) else False
        )
    ...
    def check_small_street(self, ds: DiceSet):
        ...
        if (
            (
                dice_list.count(1) >= 1
                and dice_list.count(2) >= 1
                and dice_list.count(3) >= 1
                and dice_list.count(4) >= 1
            )
            or (
                dice_list.count(2) >= 1
                and dice_list.count(3) >= 1
                and dice_list.count(4) >= 1
                and dice_list.count(5) >= 1
            )
            or (
                dice_list.count(3) >= 1
                and dice_list.count(4) >= 1
                and dice_list.count(5) >= 1
                and dice_list.count(6) >= 1
            )
        ):
        ...
        if has_small_street == True:
            return KniffelOptionClass(
                ...
                is_possible=True,
                ds=ds,
                id=KniffelOptions.SMALL_STREET,
            )
        else:
            return KniffelOptionClass(
                name="small-street",
    ...
    def check_large_street(self, ds: DiceSet):
        ...
        if has_large_street == True:
            return KniffelOptionClass(
                ...
                is_possible=True,
                ds=ds,
                id=KniffelOptions.LARGE_STREET,
            )
        else:
            return KniffelOptionClass(
                name="large-street",
